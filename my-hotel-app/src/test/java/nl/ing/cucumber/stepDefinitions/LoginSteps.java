...
public class LoginSteps {
	...
	public void user_opens_the_hotelapp() throws Throwable {
		...
		System.out.println(MyWebDriver.driver.toString());
	}
	...
	public void user_enters_username(String username) throws Throwable {
		MyWebDriver.driver.findElement(By.id("username")).clear();
	...
	public void user_enters_password(String password) throws Throwable {
		MyWebDriver.driver.findElement(By.id("password")).clear();
	...
	public void user_Logout_from_the_application() throws Throwable {
		MyWebDriver.driver.findElement(By.partialLinkText("Logout")).click();
